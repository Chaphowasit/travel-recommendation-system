...
def create_data_model(input):
    ...
    data["time_windows"] = available_times  # Expecting `visit_hours` to provide the list of time windows per location
...
def print_routes(computed_routes):
    ...
    print(f"Total waiting time of all routes: {format_time(computed_routes['total_waiting_time'])}")
        ...
        
{
  'days': 3, 
  'place_ids': [
    'H0021', 'H0021', 'H0021', 'H0021', 
    'A0002', 'A0055', 'A0153', 'A0155', 
    'A0234', 'A0238', 'A0423', 'A0444', 
    'A0512', 'A0527', 'A0815'
  ], 
  'time_windows': [
    [(0, 28), (264, 288)], 
